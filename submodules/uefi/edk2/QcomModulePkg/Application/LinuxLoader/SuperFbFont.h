...
/* Art glyphs use full 256px cells, so the width/advance need 16 bits. */
typedef struct {
  CHAR16  Ch;        /* Unicode code point */
  UINT32  Offset;    /* byte offset into gSfbArtBitmap */
  UINT16  Width;     /* glyph width in pixels (256) */
  UINT16  Advance;   /* pen advance in pixels (256) */
} SFB_ART_GLYPH;
...
extern CONST SFB_ART_GLYPH  gSfbArtGlyphs[];
